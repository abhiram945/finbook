...
export const Sign=()=>{
    ...
    const {setUserData, loading,setLoading} = useContext(finbookContext);
    ...
    return window.localStorage.getItem("token")?<Navigate to="/"/>: <div className="signPageContainer flex alignCenter justifyCenter">
